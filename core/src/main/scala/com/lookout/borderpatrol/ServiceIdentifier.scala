 ...
 * @param redirect The location to send a user when a request to this service is Unauthorized
 */
case class ServiceIdentifier(name: String, path: Path, subdomain: String, redirect: String)
